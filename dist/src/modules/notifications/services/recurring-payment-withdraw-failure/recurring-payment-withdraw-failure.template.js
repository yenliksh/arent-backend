...
exports.recurringPaymentWithdrawFailureTemplate = void 0;
const recurringPaymentWithdrawFailureTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
