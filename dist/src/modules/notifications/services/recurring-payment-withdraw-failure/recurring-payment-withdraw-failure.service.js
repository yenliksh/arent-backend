...
exports.RecurringPaymentWithdrawFailureService = void 0;
...
const recurring_payment_withdraw_failure_template_1 = require("./recurring-payment-withdraw-failure.template");
let RecurringPaymentWithdrawFailureService = class RecurringPaymentWithdrawFailureService extends notification_recipients_base_1.BaseNotificationRecipients {
    ...
    templateMessage(recipientName) {
        const message = {
            ...
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: (0, recurring_payment_withdraw_failure_template_1.recurringPaymentWithdrawFailureTemplate)({
                        recipientName,
...
RecurringPaymentWithdrawFailureService = __decorate([
...
exports.RecurringPaymentWithdrawFailureService = RecurringPaymentWithdrawFailureService;
//# sourceMappingURL=recurring-payment-withdraw-failure.service.js.map