...
exports.contractOfferStatusChangedTemplate = void 0;
const contractOfferStatusChangedTemplate = ({ recipientName, buttonLink, isLandLord, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
