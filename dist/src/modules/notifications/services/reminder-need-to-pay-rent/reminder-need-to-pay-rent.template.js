...
exports.reminderNeedToPayRentTemplate = void 0;
const reminderNeedToPayRentTemplate = ({ recipientName, buttonLink, address, paymentAmount, withdrawFundsDate, currency, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
