...
exports.recurringPaymentLastWithdrawFailureTemplate = void 0;
const recurringPaymentLastWithdrawFailureTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
