...
exports.ApartmentAdRejectService = void 0;
...
const apartment_ad_rejected_template_1 = require("./apartment-ad-rejected.template");
let ApartmentAdRejectService = class ApartmentAdRejectService extends notification_recipients_base_1.BaseNotificationRecipients {
    ...
    templateMessage(recipientName) {
        const message = {
            ...
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: (0, apartment_ad_rejected_template_1.apartmentAdRejectedTemplate)({
                        recipientName,
...
ApartmentAdRejectService = __decorate([
...
exports.ApartmentAdRejectService = ApartmentAdRejectService;
//# sourceMappingURL=apartment-ad-rejected.service.js.map