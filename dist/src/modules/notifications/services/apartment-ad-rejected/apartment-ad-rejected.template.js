...
exports.apartmentAdRejectedTemplate = void 0;
const apartmentAdRejectedTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
...
`;
exports.apartmentAdRejectedTemplate = apartmentAdRejectedTemplate;
//# sourceMappingURL=apartment-ad-rejected.template.js.map