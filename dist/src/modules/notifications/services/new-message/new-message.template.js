...
const newMessageTemplate = ({ recipientName, senderName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
