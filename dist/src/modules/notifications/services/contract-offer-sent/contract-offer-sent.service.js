...
exports.ContractOfferSentService = void 0;
...
const contract_offer_sent_template_1 = require("./contract-offer-sent.template");
let ContractOfferSentService = class ContractOfferSentService extends notification_recipients_base_1.BaseNotificationRecipients {
    ...
    templateMessage(recipientName) {
        const message = {
            ...
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: (0, contract_offer_sent_template_1.contractOfferSentTemplate)({
                        recipientName,
...
ContractOfferSentService = __decorate([
...
exports.ContractOfferSentService = ContractOfferSentService;
//# sourceMappingURL=contract-offer-sent.service.js.map