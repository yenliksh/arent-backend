...
exports.contractOfferSentTemplate = void 0;
const contractOfferSentTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
...
`;
exports.contractOfferSentTemplate = contractOfferSentTemplate;
//# sourceMappingURL=contract-offer-sent.template.js.map