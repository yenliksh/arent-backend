...
exports.contractConcludedTenantTemplate = void 0;
const contractConcludedTenantTemplate = ({ recipientName, buttonLink, withdrawFundsDate, paymentAmount, address, startDate, endDate, currency, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
