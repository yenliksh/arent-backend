...
exports.paymentTransferSuccessTemplate = void 0;
const paymentTransferSuccessTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
