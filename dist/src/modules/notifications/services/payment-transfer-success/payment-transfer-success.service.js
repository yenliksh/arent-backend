...
exports.PaymentTransferSuccessService = void 0;
...
const payment_transfer_success_template_1 = require("./payment-transfer-success.template");
let PaymentTransferSuccessService = class PaymentTransferSuccessService extends notification_recipients_base_1.BaseNotificationRecipients {
    ...
    templateMessage(recipientName) {
        const message = {
            ...
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: (0, payment_transfer_success_template_1.paymentTransferSuccessTemplate)({
                        recipientName,
...
PaymentTransferSuccessService = __decorate([
...
exports.PaymentTransferSuccessService = PaymentTransferSuccessService;
//# sourceMappingURL=payment-transfer-success.service.js.map