...
exports.BookingRequestStatusChangedService = void 0;
...
const booking_request_status_changed_template_1 = require("./booking-request-status-changed.template");
let BookingRequestStatusChangedService = class BookingRequestStatusChangedService extends notification_recipients_base_1.BaseNotificationRecipients {
    ...
    templateMessage(recipientName) {
        const message = {
            ...
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: (0, booking_request_status_changed_template_1.bookingRequestStatusChangedTemplate)({
                        recipientName,
                        buttonLink: (0, slash_agnostic_1.slashAgnostic)(this.frontendUrl, 'chat'),
                    }),
                },
            },
        };
...
BookingRequestStatusChangedService = __decorate([
...
exports.BookingRequestStatusChangedService = BookingRequestStatusChangedService;
//# sourceMappingURL=booking-request-status-changed.service.js.map