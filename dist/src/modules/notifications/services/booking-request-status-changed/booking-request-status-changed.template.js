...
exports.bookingRequestStatusChangedTemplate = void 0;
const bookingRequestStatusChangedTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
...
`;
exports.bookingRequestStatusChangedTemplate = bookingRequestStatusChangedTemplate;
//# sourceMappingURL=booking-request-status-changed.template.js.map