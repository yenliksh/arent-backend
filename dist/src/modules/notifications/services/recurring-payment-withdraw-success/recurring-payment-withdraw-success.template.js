...
exports.recurringPaymentWithdrawSuccessTemplate = void 0;
const recurringPaymentWithdrawSuccessTemplate = ({ recipientName, buttonLink, withdrawFundsDate, paymentAmount, address, startDate, endDate, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
