...
exports.ApartmentAdApprovedService = void 0;
...
const apartment_ad_approved_template_1 = require("./apartment-ad-approved.template");
let ApartmentAdApprovedService = class ApartmentAdApprovedService extends notification_recipients_base_1.BaseNotificationRecipients {
    ...
    templateMessage(recipientName) {
        const message = {
            ...
            Body: {
                Html: {
                    Charset: 'UTF-8',
                    Data: (0, apartment_ad_approved_template_1.apartmentAdApprovedTemplate)({
                        recipientName,
                        buttonLink: (0, slash_agnostic_1.slashAgnostic)(this.frontendUrl, 'dashboard?activeTab=ADS'),
                    }),
                },
            },
        };
...
ApartmentAdApprovedService = __decorate([
...
exports.ApartmentAdApprovedService = ApartmentAdApprovedService;
//# sourceMappingURL=apartment-ad-approved.service.js.map