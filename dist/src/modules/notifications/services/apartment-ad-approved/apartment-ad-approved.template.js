...
exports.apartmentAdApprovedTemplate = void 0;
const apartmentAdApprovedTemplate = ({ recipientName, buttonLink, fbLink = process.env.FACEBOOK, instagramLink = process.env.INSTAGRAM, linkedInLink = process.env.LINKEDIN, }) => `
