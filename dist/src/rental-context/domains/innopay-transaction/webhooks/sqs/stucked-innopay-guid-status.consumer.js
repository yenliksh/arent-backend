...
exports.StuckedInnopayGuidStatusConsumer = void 0;
...
let StuckedInnopayGuidStatusConsumer = class StuckedInnopayGuidStatusConsumer {
    ...
    async handle(queueMessage) {
        ...
        if (!isSqsMessageTypeValid(body)) {
            ...
            throw new exceptions_1.ArgumentInvalidException(`Invalid sqs message type for check stucked innopay guid status`);
        }
        this.innopayTransactionBullsQueue.addHandleCustomerReferenceJob(body);
    }
};
__decorate([
    (0, nestjs_sqs_1.SqsMessageHandler)(constants_1.SQSQueues.stuckedInnopayGuidStatusQueue.name, false),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StuckedInnopayGuidStatusConsumer.prototype, "handle", null);
StuckedInnopayGuidStatusConsumer = __decorate([
...
exports.StuckedInnopayGuidStatusConsumer = StuckedInnopayGuidStatusConsumer;
//# sourceMappingURL=stucked-innopay-guid-status.consumer.js.map