...
export declare type CreateContractStatus = Extract<ContractStatus, ContractStatus.CREATED | ContractStatus.CONCLUDED>;
export declare enum CancellationTrigger {
    TENANT = "TENANT",
    LANDLORD = "LANDLORD"
}
