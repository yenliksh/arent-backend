...
exports.ContractTemporaryConcludeProcessor = void 0;
...
let ContractTemporaryConcludeProcessor = class ContractTemporaryConcludeProcessor {
    ...
    async handle(job) {
        ...
        try {
            contract = await this.contractRepository.findOneByTenantAndChatId(chatId, tenantId, trxId);
            if (!contract) {
            ...
            const temporaryPaymentTransactions = contract.temporaryConclude();
            ...
            const customerReference = cashInResult.customerReference.toString();
            ...
            await Promise.all([
                ...
                temporaryPaymentTransactions.map((temporaryTransaction) => this.temporaryPaymentTransactionRepository.save(temporaryTransaction, trxId)),
        ...
        this.contractOfferPubSubService.publishInnopayPageUrl(tenantId, redirectURL, startTransactionTime, {
...
__decorate([
    (0, bull_1.Process)(types_2.ContractOfferProcess.TEMPORARY_CONCLUDE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ContractTemporaryConcludeProcessor.prototype, "handle", null);
ContractTemporaryConcludeProcessor = __decorate([
...
exports.ContractTemporaryConcludeProcessor = ContractTemporaryConcludeProcessor;
//# sourceMappingURL=temporapy-contract-conclude.processor.js.map