...
import { TemporaryConcludeJobPayload } from '../types';
export declare class ContractTemporaryConcludeProcessor {
    ...
    handle(job: Job<TemporaryConcludeJobPayload>): Promise<void>;
