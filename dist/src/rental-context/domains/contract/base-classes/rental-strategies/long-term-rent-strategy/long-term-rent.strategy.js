...
exports.LongTermRentStrategy = void 0;
...
class LongTermRentStrategy extends rental_strategy_base_1.RentalStrategyBase {
    constructor({ contract }) {
        ...
        this.logger = new common_1.Logger('LongTermRentStrategy');
        if (contract.isFined) {
    ...
    handle() {
        ...
        return {
            data: stayDates.map(({ startDate, endDate }, index) => {
                ...
                const totalAmountToBeTransferred = (cost * (1 - this._recipientTaxRate)) / (1 - constants_1.INNOPAY_CASH_OUT_TAX_RATE);
                ...
                return {
                    ...
                    rentPeriodStrategyType: types_1.RentPeriodStrategyType.LONG_TERM_RENT,
                };
            }),
        };
    }
}
exports.LongTermRentStrategy = LongTermRentStrategy;
//# sourceMappingURL=long-term-rent.strategy.js.map