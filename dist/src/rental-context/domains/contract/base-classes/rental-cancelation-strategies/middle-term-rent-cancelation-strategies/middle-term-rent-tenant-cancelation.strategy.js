...
exports.MiddleTermRentTenantCancelationStrategy = void 0;
...
class MiddleTermRentTenantCancelationStrategy extends base_middle_term_rent_cancelation_strategy_1.BaseMiddleTermRentCancelationStrategy {
    constructor(contract, transactions) {
        ...
        this._cancelationType = enums_1.MiddleTermRentCancellationPolicyType.DEFAULT;
    }
    ...
    getUnpaidAmountOfHours(now = date_util_1.DateUtil.utcNow()) {
        ...
        if (nextStayTransaction &&
            [types_1.PaymentTransactionStatus.COMPLETED, types_1.PaymentTransactionStatus.CASH_OUT_WAITING].includes(nextStayTransaction.status)) {
    ...
    handle(checkOutDate) {
        ...
        if (isNotYetStayTime) {
            ...
            const innopayCashOutCompensationTaxRate = 1 - constants_1.INNOPAY_CASH_OUT_TAX_RATE;
            ...
            const transferAmountToPlatform = firstPaidTransaction.totalAmountPayable -
                transferAmountToRecipient -
                firstPaidTransaction.totalAmountPayable * constants_1.INNOPAY_CASH_IN_TAX_RATE;
            return {
                strategyType: types_2.RentPeriodStrategyType.MIDDLE_TERM_RENT,
                cancelationPolicyType: this._cancelationType,
                cancelationDate: now.toISOString(),
                ...
                transferAmountToRecipient: (0, cost_rounds_util_1.costCeil)(transferAmountToRecipient),
                transferAmountToPlatform: (0, cost_rounds_util_1.costFloor)(transferAmountToPlatform),
                checkoutType: types_3.LongPeriodTenantCheckOutCancelationType.NOT_ALLOWED_REFUND,
            };
        }
        if (!checkOutDate) {
    ...
    computeRefundByFirstTransaction() {
        ...
        const refundsAmount = (0, cost_rounds_util_1.costCeil)(totalAmountPayable - taxAmount - totalAmountPayable * constants_1.INNOPAY_CASH_IN_TAX_RATE);
        const totalAmountToBeTransferred = 0;
        const totalRevenue = taxAmount;
        return [refundsAmount, totalAmountToBeTransferred, totalRevenue];
    }
}
exports.MiddleTermRentTenantCancelationStrategy = MiddleTermRentTenantCancelationStrategy;
MiddleTermRentTenantCancelationStrategy.cancelationRulesMap = {
    [enums_1.MiddleTermRentCancellationPolicyType.DEFAULT]: {
        relativeBooking: {
            cancellationTime: 24,
...
//# sourceMappingURL=middle-term-rent-tenant-cancelation.strategy.js.map