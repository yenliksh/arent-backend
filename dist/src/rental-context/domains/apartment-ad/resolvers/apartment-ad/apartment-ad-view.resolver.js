...
exports.ApartmentAdViewResolver = void 0;
...
let ApartmentAdViewResolver = class ApartmentAdViewResolver {
    ...
    async shortTermRent(apartmentAd, apartmentAdShortTermRentOrmEntityLoader) {
        ...
        return apartment_ad_short_term_rent_model_1.ApartmentAdShortTermRentViewModel.create(result);
    }
    async longTermRent(apartmentAd, apartmentAdLongTermRentOrmEntityLoader) {
        ...
        return apartment_ad_long_term_rent_model_1.ApartmentAdLongTermRentViewModel.create(result);
    }
};
__decorate([
...
], ApartmentAdViewResolver.prototype, "landlord", null);
__decorate([
    (0, graphql_1.ResolveField)(() => apartment_ad_short_term_rent_model_1.ApartmentAdShortTermRentViewModel),
    __param(0, (0, graphql_1.Parent)()),
    __param(1, (0, dataloader_1.Loader)(apartment_ad_short_term_rent_dataloader_1.ApartmentAdShortTermRentOrmEntityLoader.name)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [apartment_ad_model_1.ApartmentAdViewModel,
        dataloader_2.default]),
    __metadata("design:returntype", Promise)
], ApartmentAdViewResolver.prototype, "shortTermRent", null);
__decorate([
    (0, graphql_1.ResolveField)(() => apartment_ad_long_term_rent_model_1.ApartmentAdLongTermRentViewModel),
    __param(0, (0, graphql_1.Parent)()),
    ...
    __metadata("design:paramtypes", [apartment_ad_model_1.ApartmentAdViewModel,
        dataloader_2.default]),
    __metadata("design:returntype", Promise)
], ApartmentAdViewResolver.prototype, "longTermRent", null);
ApartmentAdViewResolver = __decorate([
    (0, graphql_1.Resolver)(() => apartment_ad_model_1.ApartmentAdViewModel)
], ApartmentAdViewResolver);
exports.ApartmentAdViewResolver = ApartmentAdViewResolver;
//# sourceMappingURL=apartment-ad-view.resolver.js.map