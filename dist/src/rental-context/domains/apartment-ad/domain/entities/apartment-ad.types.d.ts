...
export declare type ApartmentAdEditProps = ApartmentAdBaseProps;
export declare type ApartmentAdProps = {
    landlordId: UUID;
...
export declare type ImportantInfoSetProps = ApartmentRulesProps & {
...
export declare class ILockedDate {
    startDate: string;
    endDate: string;
}
