...
export declare enum RentPeriodType {
    LONG_TERM = "LONG_TERM",
    SHORT_TERM = "SHORT_TERM",
    ALL = "ALL"
}
export declare enum ApartmentRuleType {
...
export declare enum ApartmentCategory {
    FLAT = "FLAT",
    HOUSE = "HOUSE",
...
export declare enum StageCreatingType {
...
export declare enum ApartmentAdStatusType {
    ACTIVE = "ACTIVE",
    PUBLISHED = "PUBLISHED",
...
export declare enum LegalCapacityType {
    INDIVIDUAL = "INDIVIDUAL",
    LEGAL_ENTITY = "LEGAL_ENTITY"
}
export declare type AdEditActions = 'CREATE' | 'REMOVE' | 'UPDATE';
