...
export declare abstract class LongTermRentFilterPort {
    ...
    abstract applyRulesWithGestAffectedFilters(inputFilters: FindLongTermRentAdsFilterRequest, filters: QueryDslQueryContainer[]): void;
    abstract applyPriceRangeFilters(inputFilters: FindLongTermRentAdsFilterRequest, filters: QueryDslQueryContainer[]): void;
}
