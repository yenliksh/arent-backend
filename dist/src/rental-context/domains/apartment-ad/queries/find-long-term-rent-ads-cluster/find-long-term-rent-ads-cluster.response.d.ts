...
export declare class FindLongTermRentAdsClusterResponse {
    data: ApartmentAdClusterModel[];
    clusterInfo: ApartmentAdClusterInfoModel;
    slugs?: SlugModel[];
    static create: (data: (LongTermRentDocumentProps | ShortTermRentDocumentProps)[], totalItems: number, slugs?: SlugModel[]) => FindLongTermRentAdsClusterResponse;
}
