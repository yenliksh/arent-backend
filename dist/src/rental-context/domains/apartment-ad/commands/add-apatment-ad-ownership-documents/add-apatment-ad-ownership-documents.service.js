...
exports.AddApartmentAdOwnershipDocumentsService = void 0;
...
let AddApartmentAdOwnershipDocumentsService = class AddApartmentAdOwnershipDocumentsService {
    ...
    async handle(dto, userId) {
        ...
        if (!apartmentAd.isLongTermRent) {
            return (0, oxide_ts_1.Err)(new common_1.UnprocessableEntityException('Changes cannot be applied'));
        }
...
AddApartmentAdOwnershipDocumentsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [apartment_ad_repository_1.ApartmentAdRepository])
], AddApartmentAdOwnershipDocumentsService);
exports.AddApartmentAdOwnershipDocumentsService = AddApartmentAdOwnershipDocumentsService;
//# sourceMappingURL=add-apatment-ad-ownership-documents.service.js.map