...
exports.EditApartmentAdTypeService = void 0;
...
let EditApartmentAdTypeService = class EditApartmentAdTypeService {
    ...
    async handle(dto, userId) {
        ...
        if (apartmentType)
            apartmentAd.setApartmentType(apartmentType);
...
EditApartmentAdTypeService = __decorate([
...
exports.EditApartmentAdTypeService = EditApartmentAdTypeService;
//# sourceMappingURL=edit-apartment-ad-type.service.js.map