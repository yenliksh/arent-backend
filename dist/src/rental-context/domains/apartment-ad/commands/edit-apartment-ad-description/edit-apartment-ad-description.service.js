...
exports.EditApartmentAdDescriptionService = void 0;
...
let EditApartmentAdDescriptionService = class EditApartmentAdDescriptionService {
    ...
    async handle(dto, userId) {
        const { id, name, description, remoteView, selfCheckIn, freeParking, workSpace, quite, forFamily } = dto;
...
EditApartmentAdDescriptionService = __decorate([
...
exports.EditApartmentAdDescriptionService = EditApartmentAdDescriptionService;
//# sourceMappingURL=edit-apartment-ad-description.service.js.map