...
exports.EditApartmentAdImportantInfoService = void 0;
...
let EditApartmentAdImportantInfoService = class EditApartmentAdImportantInfoService {
    ...
    async handle(dto, userId) {
        const { id, allowedToHangingOut, allowedToSmoke, allowedWithChildren, allowedWithPets, arrivalTime, departureTime, rentBookingType, cancellationPolicy, } = dto;
        ...
        apartmentAd.setImportantInfo({
            allowedToHangingOut,
            allowedToSmoke,
            allowedWithChildren,
            allowedWithPets,
            shortTermRentArrivalTime: arrivalTime,
            shortTermRentDepartureTime: departureTime,
            shortTermRentBookingType: rentBookingType,
            shortTermRentCancellationPolicyType: cancellationPolicy,
        });
...
EditApartmentAdImportantInfoService = __decorate([
...
exports.EditApartmentAdImportantInfoService = EditApartmentAdImportantInfoService;
//# sourceMappingURL=edit-apartment-ad-important-info.service.js.map