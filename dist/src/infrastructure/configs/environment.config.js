...
exports.validationSchema = exports.loadConfiguration = exports.currentEnvironment = void 0;
const process = require("process");
const Joi = require("joi");
const loadConfiguration = () => {
    var _a;
    exports.currentEnvironment = process.env.APP_ENVIRONMENT;
    return {
        nodeEnv: process.env.NODE_ENV,
        port: process.env.PORT,
        backendUrl: process.env.BACKEND_URL,
        corsClientUrls: (_a = process.env.CORS_CLIENT_URLS) === null || _a === void 0 ? void 0 : _a.split(','),
        seed: {
        ...
        jwt: {
            ...
            signUpExpiresIn: parseInt(process.env.JWT_SIGN_UP_EXPIRES_IN),
        },
        redis: {
            pubSub: {
