...
async function up(knex) {
    ...
    await knex.schema.createTable(tableName, (t) => {
        ...
        t.check(`("apartmentRentPeriodType" = 'SHORT_TERM' AND "arrivalDate" IS NOT NULL AND "departureDate" IS NOT NULL AND "arrivalDate" < "departureDate")
      OR ("apartmentRentPeriodType" = 'LONG_TERM' AND "arrivalDate" IS NULL AND "departureDate" IS NULL)`);
    });
    return knex.schema.raw(`ALTER TABLE ${tableName}
...
exports.down = down;
//# sourceMappingURL=20220708082023_create-contract-requests-table.js.map