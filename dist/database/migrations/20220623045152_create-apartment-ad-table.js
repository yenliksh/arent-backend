...
async function up(knex) {
    ...
    return knex.schema.createTable(tableName, (t) => {
        ...
        t.check('("defaultPaymentMethod" IS NOT NULL AND "innopayCardId" IS NOT NULL) OR ("defaultPaymentMethod" IS NULL AND "innopayCardId" IS NULL)');
...
exports.down = down;
//# sourceMappingURL=20220623045152_create-apartment-ad-table.js.map