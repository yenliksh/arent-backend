...
@CommandHandler(ApproveAdShortTermRentCommand)
export class ApproveAdShortTermRentHandler implements ICommandHandler<ApproveAdShortTermRentCommand> {
  constructor(
  ...
  public async execute(command: ApproveAdShortTermRentCommand): Promise<Result<UUID, HttpException>> {
