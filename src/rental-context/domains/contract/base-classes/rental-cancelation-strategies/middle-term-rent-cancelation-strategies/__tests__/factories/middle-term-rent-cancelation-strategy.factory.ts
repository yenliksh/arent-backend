...
type CashOutWaitingMiddleTermRentTransactionsAmount = 1 | 2 | 3;

export const middleTermRentTenantCancelationStrategyFactory = ({
  contractCreateProps,
  ...
  const middleTermRentCancelationStrategy = new MiddleTermRentTenantCancelationStrategy(contract, transactions);

  return middleTermRentCancelationStrategy;
};

export const middleTermRentLandlordCancelationStrategyFactory = ({
  contractCreateProps,
  cashOutWaitingTransactionsAmount,
  completeTransactions,
}: {
  ...
  const middleTermRentCancelationStrategy = new MiddleTermRentLandlordCancelationStrategy(contract, transactions);
