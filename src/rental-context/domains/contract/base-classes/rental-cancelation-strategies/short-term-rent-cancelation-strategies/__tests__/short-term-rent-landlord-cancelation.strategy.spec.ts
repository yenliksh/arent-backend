...
import { shortTermRentLandlordCancelationStrategyFactory } from './factories/short-term-rent-cancelation-strategy.factory';

// ALL TESTS COPY AND PASTED FROM middle-term-rent-landlord-cancelation.strategy.spec AND ADOPTED
describe('ShortTermRentLandlordCancelationStrategy', () => {
  describe('more than 24 hours left before arrival', () => {
    it('refund to tenant with livin tax (valid excuse, 1 cash-out-waiting)', () => {
      ...
      const paymentManager = shortTermRentLandlordCancelationStrategyFactory({
        contractCreateProps: {
          arrivalDate: '2022-11-30T07:00:00.000Z',
          departureDate: '2022-12-30T05:00:00.000Z',
          cost: 1000000,
