...
import { TenantRecurrentPayCommand } from './tenant-recurrent-pay.command';

@CommandHandler(TenantRecurrentPayCommand)
export class TenantRecurrentPayHandler implements ICommandHandler<TenantRecurrentPayCommand> {
  constructor(
